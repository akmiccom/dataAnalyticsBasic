...
- クロス集計表の作成
- 特化係数 - 特化係数が 1 であれば、部分集団の割合が全体集団と同じ - 1 より離れた値をとると、交互作用効果があることを意味する
...
$$ t 時点での増加率 = \frac{t 時点の値 - 基準時点の値}{基準時点の値} \times 100 $$
...
- 季節指数: ひと月当りの平均を 100 とし各月の季節成分の大きさを示す
$$ 季節指数 = \frac{各単位の値}{基準値} \times 100 $$
